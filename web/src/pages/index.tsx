	...
	return (
		<div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
			<main>
				<Image
					src={logoImg}
					alt="Dois celulares exibindo uma préiva da aplicação móvel"
					quality={100}
				/>
				...
				<form className="mt-10 flex gap-2" onSubmit={createPoll}>
					...
					/>
					<button
						className="bg-yellow-500 px-6 py-4 text-gray-900 rounded font-bold text-sm uppercase hover:bg-yellow-700"
						type="submit"
					>
						Criar meu bolão
					</button>
